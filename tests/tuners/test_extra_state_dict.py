...
class TestExtraStateDict(unittest.TestCase):
    ...
    def test_swift_extra_state_dict(self):
        ...
        self.assertTrue(os.path.isfile(os.path.join(self.tmp_dir, 'adapter_model.bin')))
        state_dict = torch.load(os.path.join(self.tmp_dir, 'adapter_model.bin'))
    ...
    def test_swift_modules_to_save(self):
        ...
        self.assertTrue(torch.allclose(state_dict['classifier.weight'], model.base_model.classifier.modules_to_save['lora2'].weight))
