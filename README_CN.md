...
## 🎉 新闻
- 2024.08.06: 支持minicpm-v-v2_6-chat, 使用`swift infer --model_type minicpm-v-v2_6-chat`进行推理体验, 使用`swift sft --model_type minicpm-v-v2_6-chat --dataset coco-en-mini#20000`进行图片训练, 使用`swift sft --model_type minicpm-v-v2_6-chat --dataset video-chatgpt`进行视频训练.
