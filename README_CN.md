...
## 🎉 新闻
- 🔥 2026.09.21: Day-0 支持 [DeepSeek-V4.1-Flash](https://www.modelscope.cn/models/deepseek-ai/DeepSeek-V4.1-Flash)：Megatron-SWIFT 全参数训练（SFT 与 GRPO）以及 vLLM 推理，示例参考 [这里](examples/models/deepseek_v41)。
