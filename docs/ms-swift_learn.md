...
```
你需要完成的任务和目标：为Template类的生成注释，要求准确详细，风格清晰易懂，能够使得阅读者轻易理解当前类的含义和功能。
对整体类的注释需要包括以下部分：
1、类功能
...
```
你需要完成的任务和目标：为Template类的_patch_flash_attention_forward方法的生成注释，具体为5746行-5781行，要求准确详细，风格清晰易懂，能够使得阅读者轻易理解当前函数的含义和功能。
对整体函数的注释需要包括以下部分：
1、功能（注意：在函数定义和函数功能之间，不要再重复描述功能相关的，函数功能相关的都注释在函数功能之中）
2、参数
3、返回
4、示例，举1-2个即可
5、如果已经有英文或者中文注释，则该写到以上的相应部分，比如函数功能、参数、返回值和使用示例部分。
6、对方法中的代码体逐行进行注释
7、如果代码中涉及到tensor的运算，则注释相关tensor的shape以及tensor的运算过程
8、注释的文字描述语句要足够精炼准确，给出每一步的变化过程
9、如果代码很长的话，使用分步骤描述，则使用 1> 2> 3>...的格式
10、如果存在难于理解的代码行，进行详细的注释进行说明，但是保持语句描述简单易懂，同时举例描述变化过程
```

（2）

```
按照_pad_sequence方法的注释风格、简易程度和重点代码的注释，重新对Template类的_data_collator_mm_data方法进行注释，具体为5875行-5961行。
```

（3）

```
你需要完成的任务和目标：为utils类的_split_str_by_regex方法的生成注释，具体为165行-175行，要求准确详细，风格清晰易懂，能够使得阅读者轻易理解当前函数的含义和功能。
对整体函数的注释需要包括以下部分：
1、函数功能（注意：在函数定义和函数功能之间，不要再重复描述功能相关的，函数功能相关的都注释在函数功能之中）
2、参数
3、返回值
4、注意：不用示例
5、如果已经有英文或者中文注释，则该写到以上的相应部分，比如函数功能、参数、返回值和使用示例部分。
...
```
你需要完成的任务和目标：为template_inputs.py脚本生成注释，要求准确详细，风格清晰易懂，能够使得阅读者轻易理解当前脚本的含义和功能。
一、在脚本开头给出模块功能概述，在详尽描述的同时，保持描述简练不要过度冗余
二、对类的注释需要包括以下部分：
1、类功能
2、（1）继承关系说明（如果没有继承可以跳过）；（2）应用场景
3、使用示例
三、对类中各个方法和脚本中方法的注释包括以下部分：
1、函数功能
2、参数
3、返回值
4、使用示例
...
```
你需要完成的任务和目标：为Template类的_preprocess_inputs方法的生成注释，具体为680行-689行，要求准确详细，风格清晰易懂，能够使得阅读者轻易理解当前函数的含义和功能。
```
