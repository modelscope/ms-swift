...
框架内置的 `ThinkingModelTipsScheduler` 类展示了如何通过重写 `run()` 方法来实现完全自定义的多轮推理逻辑。请参考[内置多轮调度器实现](https://github.com/modelscope/ms-swift/blob/main/swift/plugins/multi_turn.py)
...
具体实现可以参考[ThinkingModelTipsScheduler](https://github.com/modelscope/ms-swift/blob/main/swift/plugins/multi_turn.py)类
...
具体的实现请参考[内置实现](https://github.com/modelscope/ms-swift/blob/main/swift/plugins/multi_turn.py)
