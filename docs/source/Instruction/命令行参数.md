...
- token_entropy_percentile_threshold: 过滤 entropy 较低的 token loss 计算，设置过滤百分位，具体参考[文档](../Instruction/GRPO/AdvancedResearch/entropy_mask.md), 默认为0。
- log_entropy: 记录 entropy 相关指标，默认为False。
