...
```jsonl
{"query": "55555", "response": "66666", "image": "some local path"}
{"query": "eeeee", "response": "fffff", "history": [], "image": "some http path"}
{"query": "EEEEE", "response": "FFFFF", "history": [["AAAAA", "BBBBB"], ["CCCCC", "DDDDD"]], "image": "some local path"}
```
