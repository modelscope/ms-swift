...
By setting the hyperparameter `rpo_alpha`, a certain proportion of SFT loss can be mixed into the loss to improve training stability. The default value is `None`, meaning SFT loss is not included by default.
