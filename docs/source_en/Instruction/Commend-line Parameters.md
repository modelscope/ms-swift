...
- template: Template type. Refer to [Supported Models and Datasets](./Supported Models and Datasets). Defaults to the template type associated with the model. If the model is custom, this field must be set manually.
