...
By default, all checkpoints are saved. For details, see the [command-line parameter save_total_limit](https://swift.readthedocs.io/en/latest/Instruction/Command-line-parameters.html). This parameter is not supported in Megatron-SWIFT; please set save_interval to save checkpoints instead. For details, refer to the [Megatron-SWIFT command-line parameters](https://swift.readthedocs.io/en/latest/Instruction/Command-line-parameters.html).
