...
- norm_bbox: Control how the bounding box (bbox) is scaled. The options are 'norm1000', 'none', and None. The default is None, which automatically selects according to the model.
