...
- vllm_mode colocate parameter
  ...
  - offload_model: Whether to offload the training model during inference with vLLM/LMDeploy. The default is `False`.
  - offload_ref_model: Whether to offload the reference model during vLLM inference, default is False.
