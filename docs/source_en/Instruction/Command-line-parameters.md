...
- 🔥vit_gradient_checkpointing: Whether to enable gradient_checkpointing for the ViT component during multimodal model training. Defaults to None, which is equivalent to `not args.freeze_vit`. For an example, please refer to [here](https://github.com/modelscope/ms-swift/blob/main/examples/train/multimodal/vit_gradient_checkpointing.sh).
