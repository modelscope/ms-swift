...
The hyperparameters for the reward function can be found in the [Built-in Reward Functions section](./GRPO/DeveloperGuide/reward_function.md#built-in-reward-functions).
