...
- group_by_length: Whether to group samples of roughly the same length together in the training dataset (to minimize padding and improve efficiency). Defaults to False.
