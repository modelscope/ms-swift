...
- deepspeed_autotp_size: The tensor parallelism size for DeepSpeed AutoTP. Defaults to None. To use DeepSpeed AutoTP, please additionally set the `--deepspeed` argument.
