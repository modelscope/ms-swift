...
- optim_args: Optional arguments supplied to the optimizer.
- group_by_length: Whether to group together samples of roughly the same length in the training dataset (to minimize padding and improve efficiency). Only useful when applying dynamic padding.
