...
- reward_funcs: GRPO algorithm reward functions. Options include `accuracy`, `format`, `cosine`, `repetition`, and `soft_overlong`. See swift/plugins/orm.py. You can also customize your own reward functions in the plugin. Default is `[]`.
