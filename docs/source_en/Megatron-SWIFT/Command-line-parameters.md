...
- sequence_packing_scheduler: Scheduler for sequence packing and dynamic context parallel. dp_balanced: DP-balanced scheduler for sequence packing. default_dynamic_cp: Dynamic-CP scheduler for packed sequence balancing. Defaults to None.
