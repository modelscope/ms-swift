...
pip install "transformers<5.17" "trl<1.0" "peft<0.21" "datasets>=4.0,<4.8.5" -U
...
pip install pybind11 liger_kernel nvitop pre-commit math_verify py-spy wandb swanlab -U
