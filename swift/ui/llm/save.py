    ...
    with gr.Accordion(elem_id="save_param", open=True):
        with gr.Blocks() as block:
            ...
            with gr.Row():
                ...
                hub_model_id = gr.Textbox(elem_id='hub_model_id', lines=1, scale=20)
                hub_private_repo = gr.Checkbox(elem_id='hub_private_repo', scale=20)
                push_hub_strategy = gr.Dropdown(elem_id='push_hub_strategy', scale=20)
                hub_token = gr.Textbox(elem_id='hub_token', lines=1, scale=20)
