...
if TYPE_CHECKING:
    ...
    from .utils import (convert_hf2mcore, convert_mcore2hf, prepare_mcore_model, adapter_load_context, prepare_adapter)
    ...
    _import_structure = {
        ...
        'utils':
        ['convert_hf2mcore', 'convert_mcore2hf', 'prepare_mcore_model', 'adapter_load_context', 'prepare_adapter'],
