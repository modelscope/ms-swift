...
def model_provider(pre_process=True,
                   post_process=True, vp_stage: Optional[int] = None) -> Union['GPTModel', 'MultimodalGPTModel', megatron.legacy.model.GPTModel]:
    """Builds the model.
    ...
    if args.use_legacy_models:
        ...
        if args.mtp_num_layers is not None:
            mtp_block_spec = get_gpt_mtp_block_spec(config, transformer_layer_spec, use_transformer_engine=use_te, vp_stage=vp_stage)
