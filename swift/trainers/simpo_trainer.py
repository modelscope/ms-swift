...
class SimPOTrainer(PushToMsHubMixin, SwiftMixin, HFCPOTrainer):
...
class OldSimPOTrainer(PushToMsHubMixin, SwiftMixin, HFDPOTrainer):
    ...
    def __init__(self, *args, template: Template, test_oom_error=False, **kwargs):
        ...
        self.template = template
        self.gamma = kwargs.pop('simpo_gamma')
