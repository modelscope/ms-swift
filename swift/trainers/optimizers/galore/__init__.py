...
def get_optimizer_cls_and_kwargs_galore(
    ...
    if args.optim == 'adafactor':
        from swift.trainers.optimizers import GaLoreAdafactor
        ...
        from swift.trainers.optimizers import GaLoreAdamW
        optimizer_cls = GaLoreAdamW
        optimizer_kwargs.update(adam_kwargs)
    elif 'adamw' in args.optim and '8bit' in args.optim:
        try:
            from swift.trainers.optimizers import GaLoreAdamW8bit
