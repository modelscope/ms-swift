...
class GRPOTrainer(RLHFTrainerMixin, SwiftMixin, HFGRPOTrainer):
    ...
    def __init__(self,
        ...
        # Initialize default values; may be updated in _prepare_vllm
        self.use_fast_infer = self.args.use_vllm  # whether to use the PT backend
