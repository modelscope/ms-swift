...
class Seq2SeqTrainer(SwiftMixin, DataLoaderMixin, HfSeq2SeqTrainer):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.args.loss_type == 'route_hybrid_infonce' and hasattr(self.compute_loss_func, 'initialize_for_model'):
            self.compute_loss_func.initialize_for_model(self.model)
    ...
    def compute_loss(self, model, inputs, return_outputs=False, num_items_in_batch=None):
        ...
        route_label_kwargs = {}
        for key in ('label_lv1', 'label_lv2', 'label_lv3'):
            if key in inputs:
                route_label_kwargs[key] = inputs.pop(key)
