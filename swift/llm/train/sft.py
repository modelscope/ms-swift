        ...
        if not is_grpo:
            if args.packing:
                ...
                train_dataset = packing_dataset_cls(
                    self.template, train_dataset, num_proc=args.dataset_num_proc, strict=args.strict, prefix='train')
                if val_dataset is not None:
                    val_dataset = packing_dataset_cls(
                        self.template, val_dataset, num_proc=args.dataset_num_proc, strict=args.strict, prefix='val')
