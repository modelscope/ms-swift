...
register_model(
    ModelMeta(
        ...
        [
            ...
            ],ignore_file_pattern=['consolidated.safetensors'],requires=['transformers>=4.34']),
        ],
        TemplateType.llama,
...
register_model(
    ModelMeta(
        ...
        [
            ...
            ],ignore_file_pattern=[r'.+\.pt$'],tags=['moe'],requires=['transformers>=4.36']),
            ModelGroup([
                Model('AI-ModelScope/Mixtral-8x7b-AQLM-2Bit-1x16-hf', 'ISTA-DASLab/Mixtral-8x7b-AQLM-2Bit-1x16-hf'),
            ], tags=['moe'], requires=['transformers>=4.38', 'aqlm', 'torch>=2.2.0']),
        ],
        TemplateType.default,
        get_model_tokenizer_with_flash_attn,
        architectures=['MambaForCausalLM'],
...
register_model(
    ModelMeta(
        ...
        [
            ...
            ],ignore_file_pattern=['^consolidated'],tags=['moe'],requires=['transformers>=4.43']),
        ],
