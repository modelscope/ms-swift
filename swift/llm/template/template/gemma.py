...
class Gemma3nTemplate(Gemma3Template):
    boi_token_id = 255999  # <start_of_image> token id  
    boa_token_id = 256000    # Will be set dynamically for <start_of_audio>
        ...
        if inputs.audios:
            ...
            if audio_idx_list:
                ...
                if 'input_features' in audio_inputs:
                    audio_inputs['input_features'] = torch.tensor(audio_inputs['input_features']).to(self.model_info.torch_dtype)
