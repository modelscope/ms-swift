...
class DatasetLoader:
    ...
    def _load_dataset_path(dataset_meta: DatasetMeta,
        ...
        dataset = dataset_meta.preprocess_func(dataset, num_proc=num_proc, strict=strict, enable_cache=enable_cache)
    ...
    def _load_repo_dataset(
        ...
        *,
        ...
        for split in subset.split:
            ...
            dataset = subset.preprocess_func(dataset, num_proc=num_proc, strict=strict, enable_cache=enable_cache)
            dataset = DatasetLoader._remove_useless_columns(dataset)
