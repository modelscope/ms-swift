...
from ... import MediaResource, DATASET_TYPE
...
register_dataset(
    DatasetMeta(
        ...
        preprocess_func=MessagesPreprocessor(user_role='human', assistant_role='gpt', repair_messages=_repair_conversations_agent_instruct),
        tags=['chat', 'agent', 'multi-round']))
...
register_dataset(
    DatasetMeta(
        ...
        preprocess_func=ResponsePreprocessor(columns_mapping={'prompt': 'query', 'completion': 'response'}),
        remove_useless_columns=False,
        tags=['rlhf', 'kto']))
...
register_dataset(
    DatasetMeta(
        ...
        preprocess_func=ResponsePreprocessor(columns_mapping={'INSTRUCTION': 'query', 'RESPONSE': 'response'}),
        tags=['zhihu', 'qa']))
