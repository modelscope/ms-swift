...
if TYPE_CHECKING:
    ...
    from .infer import deploy_main, infer_main, merge_lora_main, merge_lora, VLLMFramework, VllmGenerationConfig, LMDeployFramework, LmdeployGenerationConfig, TransformersFramework
