...
class EvalArguments(InferArguments):
    ...
    Args:
        ...
        eval_is_chat_model (Optional[bool]): Flag to indicate if the model is a chat model or
            a generate model. Default is None.
        custom_eval_config (Optional[str]): Path to custom evaluation configuration.
            This is used when evaluating a custom dataset. Default is None.
        ...
        eval_nproc (int): Number of processes to use for evaluation. Default is 16.
            Reduce it when your evaluation timeout.
    """
