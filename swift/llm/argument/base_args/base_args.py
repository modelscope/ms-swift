...
class BaseArguments(CompatArguments, GenerationArguments, QuantizeArguments, DataArguments, TemplateArguments,
    ...
    This class consolidates arguments from GenerationArguments, QuantizeArguments,
    DataArguments, TemplateArguments, and ModelArguments.
    ...
    Args:
        ...
        cached_dataset (List[str]): Uses a cached dataset to avoid tokenization overhead during training/inference.
            This is generated by the `swift export --to_cached_dataset true ...` command. Defaults to [].
