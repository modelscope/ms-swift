...
class LMDeployFramework(InferFramework):
    ...
    def get_lmdeploy_engine(
        ...
        with LMDeployFramework._patch_pipeline(tokenizer):
    ...
    def _prepare_lmdeploy_request(lmdeploy_engine: Union[AsyncEngine, VLAsyncEngine],
        ...
        LMDeployFramework._add_stop_word(generation_config.stop_words, tokenizer.eos_token_id, tokenizer=tokenizer)
        LMDeployFramework._add_stop_word(generation_config.stop_words, template.suffix[-1], tokenizer=tokenizer)
