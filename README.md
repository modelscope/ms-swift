...
## 🎉 News
- 🔥2024.06.07: Support for Qwen2 series LLM, including 0.5B, 1.5B, 7B, and 72B Base and Instruct models. The 72B Instruct model includes int4 and int8 quantized versions.
