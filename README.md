...
- 🎁 2024.01.23: SWIFT support the sample command, this is a very important feature for complex CoT and RFT. Meanwhile, we support an [RFT script](docs/source_en/Instruction/Reinforced_Fine_tuning.md), which is able to improve performance in the math scenario.
