...
- 🎁 2024.12.04: Major update to **ms-swift 3.0**. Please refer to the [release notes and changes](https://github.com/modelscope/ms-swift/blob/v3.0.0/docs/source_en/Instruction/ReleaseNote3.0.md).
