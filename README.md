...
## 🎉 News
- 2024.08.06: Support for minicpm-v-v2_6-chat is available. Use `swift infer --model_type minicpm-v-v2_6-chat` for inference experiences, `swift sft --model_type minicpm-v-v2_6-chat --dataset coco-en-mini#20000` for image training, and `swift sft --model_type minicpm-v-v2_6-chat --dataset video-chatgpt` for video training.
