...
## 🎉 News
- 2024.08.06: Support for minicpm-v-v2_6-chat. Use `swift infer --model_type minicpm-v-v2_6-chat` for inference, and `swift sft --model_type minicpm-v-v2_6-chat --dataset coco-en-mini#20000` for training.
