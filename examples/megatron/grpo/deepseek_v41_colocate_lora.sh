...
# - LoRA weight sync exports adapter tensors only (peft format), so the Engram tables are
#   never touched: they stay in the rollout engine from the base checkpoint. Keep
